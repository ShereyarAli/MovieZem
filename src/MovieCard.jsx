...
export const MovieCard = () => {
  ...
  if(query){
    url = `https://api.themoviedb.org/3/search/movie?query=${query}&api_key=0792287ef29b02e20f6c7b6bad7e0b7d` 
  }
    else{
    url = `https://api.themoviedb.org/3/movie/popular?api_key=0792287ef29b02e20f6c7b6bad7e0b7d&page=${page}` 
  }
